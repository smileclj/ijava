/* 
 * @(#)ReflectionUtils.java    Created on 2013-9-26
...
/**
 * @author gex
 * @version $Revision: 1.0 $, $Date: 2013-9-26 下午3:51:01 $
 */
public class ReflectionUtils extends org.springframework.util.ReflectionUtils {
    ...
    /**
     * 调用Getter方法，并返回String.
     */
    public static String invokeGetterMethodReturnString(Object target, String propertyName) {
        String getterMethodName = "get" + StringUtils.capitalize(propertyName);
        Object obj = invokeMethod(target, getterMethodName, new Class[] {}, new Object[] {});
        if (obj instanceof Date) {
            return DateUtils.date2StringBySecond((Date) obj);
        }
...
//        Assert.notNull(object, "object不能为空");
    ...
    public static void main(String[] args) throws InvocationTargetException, IllegalAccessException {
        /*
         * Document document = new Document(); document.setId(2); document.setCreateDate(new Date()); DocumentVo dcoVo =
         * new DocumentVo(); ReflectionUtils.copyPorperties(dcoVo, document,new
         * String[]{"id","businessName","createDate","applyName","docTitle", "transactStatus"});
         * System.out.println(dcoVo.getId());
         */
    }
}
